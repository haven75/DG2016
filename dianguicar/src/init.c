...
void initEMIOS_0MotorAndSteer(void)
{
  //eMIOS0初始化80MHz分为1MHz
	EMIOS_0.MCR.B.GPRE= 79;   //GPRE+1=分频系数；/* Divide 80 MHz sysclk by 79+1 = 80 for 1MHz(0.1us) eMIOS clk*/
...
{                                 //PIT02msec中断立controlflag  PIT1速度反馈2ms一个控制周期
  ...
  PIT.CH[0].LDVAL.R = 160000;        //PIT0 timeout=160000 sysclks x 1sec/80M sysclks =2msec
...
void initLINFlex_0_UART (void) 
{
	...
	DIV_M=LFDIV整数部分
	DIV_F=LFDIV小数部分*16  */ 
	LINFLEX_0.LINFBRR.B.DIV_F = 7;//13;		//38400:64M-104+3	
	LINFLEX_0.LINIBRR.B.DIV_M= 69;//86;  	//波特率设置38400:80M-130+3 57600:80M-86+13 115200:80M-43+6  9600:80M-520+83
