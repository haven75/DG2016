...
#define LCD_SCL SIU.GPDO[31].R //d0 
#define LCD_SDA SIU.GPDO[30].R //d1
#define LCD_RST SIU.GPDO[29].R //res
#define LCD_DC  SIU.GPDO[28].R //ds
#define LCD_CE   SIU.GPDO[27].R 
...
void Dis_Num(byte y, byte x, int num,byte N) 
{
 ...
 // byte signx = '-';
  ...
  //if(justfy==1)
 // N=N+1;
  LCD_Print(y,x,&n[5-N]);//从ACSII码表中读取字节，然后写入液晶
}
